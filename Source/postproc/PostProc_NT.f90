...
! Transient Scalar
!   write(*,*) 'scal_tr, N_TR_SCAL=', N_TR_SCAL
...
! SCALAR: 
!    Reactivity
!   WRITE(*,*) 'Transient Scalar N_TR_SCAL=', N_TR_SCAL
...
SUBROUTINE Write_TR_Dist(o_unit, time )
   ...
   USE Model_Description, ONLY : npoly, Index_Core
   USE Distributions
   USE TR_Output      
   USE Formats
...
!                write(*,*) 'k_out_tr(1,n), k_out_tr(2,n)=',  &
!                k_out_tr(1,n), k_out_tr(2,n)
                
!                write(*,*) 'np, Index_Core(NYR, NXR) =', np, &
!                 Index_Core(k_out_tr(2,n), k_out_tr(1,n))
!                pause
