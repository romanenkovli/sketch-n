...
!--------------------------------------------------------------
!     read in a matrix in the SKETCH format
!--------------------------------------------------------------
!      write(*,*) 'maxits =', maxits
!      pause  
...
!         write(*,*) 'n = ', n
!         write(*,*) 'ipar(8), ipar(9) =', ipar(8), ipar(9)
!         write(*,'(A, 2E12.5)') ' x(1), x(n) = ', wk( ipar(8) ),&
!               wk( ipar(8) + n -1 )          
!         write(*,'(A, 2E12.5)') ' y(1), y(n) = ', wk( ipar(9) ),&
!               wk( ipar(9) + n - 1 )     
...
!     solvers. They are:                                               c
!     CG_SOLV       -- Conjugate Gradient Method                       c
...
!
!     real function distdot(n,x,ix,y,iy)
!     integer n, ix, iy
!     real x(1+(n-1)*ix), y(1+(n-1)*iy)
!
!     This interface of DISTDOT is exactly the same as that of
!     DDOT (or SDOT if real == real) from BLAS-1. It should have
...
! system of equations a * sol = y.  real version.
...
!               -3: input vector is a linear combination of others
!
!     External routines used: real distdot
!-----------------------------------------------------------------------
      integer i,k
